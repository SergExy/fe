...
function PaymentOptions() {
  ...
  if (!personalData[fieldNames.firstName] && firstAdult[fieldNames.firstName]) {
    initialValues = {
  ...
  const fullForm = (
    <section className={styles.card}>
      ...
      >
        ...
        <div className={`${styles.header} ${styles.section}`}>
          <span className={styles.text}>{fieldNames.paymentMethodLabel}</span>
        </div>
        <Form.Item name={fieldNames.paymentMethod} rules={rules.paymentMethod}>
