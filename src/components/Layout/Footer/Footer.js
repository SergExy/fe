...
import phone from "./img/contact-us/phone.svg";
import email from "./img/contact-us/email.svg";
import skype from "./img/contact-us/skype.svg";
import location from "./img/contact-us/location.svg";
import goUp from "./img/go-up.svg";
...
function Footer() {
  ...
  const subscription = (
    <section className={styles.subscription}>
      ...
      <h4 className={styles.subscription__subheader}>Будьте в курсе событий</h4>
  ...
  const bottom = (
    <div className={styles.bottomNav}>
      ...
      <div className={styles.bottomNav__year}>
