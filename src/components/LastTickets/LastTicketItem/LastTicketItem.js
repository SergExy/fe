...
function LastTicketItem({ ticket = null }) {
  const wifiImg = (
  ...
  return (
    <div className={styles.card}>
      <div className={`${styles.direction} ${styles.direction__from}`}>
        ...
        <span className={styles.direction__station}>{ticket.from.station}</span>
      </div>
      <div className={`${styles.direction} ${styles.direction__to}`}>
        <span className={styles.direction__city}>{ticket.to.city}</span>
        <span className={styles.direction__station}>{ticket.to.station}</span>
      </div>
